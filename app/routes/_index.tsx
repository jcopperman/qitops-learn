          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="relative">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <span className={`px-3 py-1 rounded-full text-sm font-medium
                          ${step.level === 'Beginner' ? 'bg-green-100 text-green-800' :
                            step.level === 'Intermediate' ? 'bg-blue-100 text-blue-800' :
                      ...
                      <div className="space-y-2">
                        {step.courses.map(course => (
                          <Link
                            ...
                            className="block p-3 rounded-md bg-indigo-50 hover:bg-indigo-100 transition-colors"
                          >
                            <div className="flex justify-between items-center">
                              <span className="text-sm font-medium text-indigo-900">{course.title}</span>
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 h-full">
                <motion.div
                  className="h-full w-1 bg-indigo-200"
                  style={{ opacity: 0.5 }}
                  initial={{ scaleY: 0 }}
                  animate={{ scaleY: 1 }}
